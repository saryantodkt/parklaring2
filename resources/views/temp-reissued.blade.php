...
@section('content')
        ...
        <div class="content">
            <div class="row">
                <div class="col">
                    <h3 class="mb-0 text-center" style="font-size: 18px; font-weight:bold; text-decoration: underline;">SURAT KETERANGAN KERJA – PENERBITAN ULANG</h3>
                    <h3 class="mb-0 text-center" style="font-size: 18px; font-weight:bold;">REISSUED CERTIFICATE OF EMPLOYMENT</h3>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    <table>
                        ...
                        <tr>
                            <td style="width: 100px;">
                                <p class="mb-0" style="text-decoration: underline;">No. Karyawan</p>
                                <p style="font-size: 10px; font-style: italic;">Employee No.</p>
                            </td>
                            <td style="width: 25px;text-align:center">:</td>
                            <td>{!! $parklaringInfo->nik !!}</td>
                        </tr>
                        <tr>
                            <td>
                                <p class="mb-0" style="text-decoration: underline;">Jabatan Terakhir</p>
                                <p style="font-size: 10px; font-style: italic;">Last Position</p>
                            </td>
                            <td style="width: 25px;text-align:center">:</td>
                            <td>{!! $parklaringInfo->last_position !!}</td>
                        </tr>
                        <tr>
                            <td>
                                <p class="mb-0" style="text-decoration: underline;">Department</p>
                                <p style="font-size: 10px; font-style: italic;">Departemen</p>
                            </td>
                            <td style="width: 25px;text-align:center">:</td>
                            <td>{!! $parklaringInfo->department->department_name !!}</td>
                        </tr>
                        <tr>
                            <td>
            ...
            <p class="mb-0">Demikian <b>surat keterangan kerja – penerbitan ulang</b> ini dibuat untuk dapat digunakan sebagaimana mestinya.</p>
            <p style="font-size: 10px; font-style: italic;">This reissued Certificate of Employment is hereby issued for its intended and lawful purpose.</p>
            <br>
            <div class="row">
                <div class="col-4">
                    <?php 
