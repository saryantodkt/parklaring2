...
@section('content')
        <div class="content">
                        ...
                        <tr>
                            ...
                            <td>
                                <table class="table table-bordered" style="font-size: 9px;" >
                                    @foreach ($parklaringInfo->contracts as $contract)
                                        <tr>
                                            <td># {!! $contract->contract_name !!}</td>
                                            <td>{{ Date::parse($contract->contract_start_date)->format('d F Y') }} - {{ Date::parse($contract->contract_end_date)->format('d F Y') }}</td>
                                        </tr>
                                    @endforeach 
                                </table>
                            </td>
            ...
            <p class="mb-0">Demikian surat keterangan kerja ini dibuat untuk dapat digunakan sebagaimana mestinya.</p>
            <p style="font-size: 10px; font-style: italic;">This Certificate of Employment is hereby issued for its proper and intended use.</p>
            <br>
            <div class="row">
                <div class="col-4">
                    <?php 
